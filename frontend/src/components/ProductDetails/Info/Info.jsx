...
const Info = ({ singleProduct }) => {
    ...
    //useRef() ile bir inputun içerisindeki değeri alabiliyoruz.
    ...
    //Tekrardan sepete ekleme işlemi yapılmaması için bu işlem kullanıldı.  
    ...
    return (
        <div className="product-info">
            ...
            {/* Bu kısım önemli!!! Editörden gelen verileri çeviriyor. */}
            ...
            <form className="variations-form">
                <div className="variations">
                    ...
                    <div className="cart-button">
                        ...
                        disabled={filteredCart} //Bu iş eklendikten sonra tekrardan butonu etkisiz hale getirmesi için yapıldı. Bu sayede tekrardan ekleme yapılamayacak.
                        onClick={()=>{
                            addToCart({
                                ...singleProduct,
                                price:discountedPrice,
                                quantity: parseInt(quantityRef.current.value) //Varsayılan olarak int türünde olmalı
                            })
                        }}
                        >Add to
                            cart</button>
